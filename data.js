module.exports= function() {
    return {
        products:[
            ...
            {id: 2, name:"lifeJacket", category:"Watersports",  description:"Protection and fashionable", price: 48.95},
            {id: 3, name:"Soccer Ball", category:"Soccer",  description:"FIFA-approved size and weight", price: 15.50},
